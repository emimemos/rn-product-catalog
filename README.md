...
| Memoización nivel 2                | `src/features/catalog/selectors.ts`                                               | `createSelector`: un selector inline dentro de `useSelector` que devuelve un objeto o array nuevo dispara un re-render en cada dispatch, tenga o no relación el cambio.                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| Escala a muchas pantallas          | `eslint.config.js`                                                                | La regla "una feature no importa de otra feature" está enforceada por `no-restricted-imports`, no por disciplina de code review.                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
